...
public class User_view_candi extends AppCompatActivity {
    ListView lv;
    String[]nomination_id,candidate_id,party,symbol,name;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_view_candi);
        lv=(ListView)findViewById(R.id.lv);
        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":8080/and_election_view2";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                //nomination_id,candidate_id,party,symbol,name
...
//                                listView1.setAdapter(ad);
                                lv.setAdapter(new custom_candi(getApplicationContext(),nomination_id,candidate_id,party,symbol,name));
//
                            }
