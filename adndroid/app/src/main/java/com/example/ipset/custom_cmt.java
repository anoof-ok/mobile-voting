...
public class custom_cmt extends BaseAdapter {
    ...
    public custom_cmt(android.content.Context applicationContext, String[] c, String[] d,String[] e) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.cust_cmt, null);
