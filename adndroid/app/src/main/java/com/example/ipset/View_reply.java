...
public class View_reply extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://" + hu + ":8080/and_view_reply";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                //complaint,complaint_date,reply
                                JSONArray js = jsonObj.getJSONArray("data");
                                cmt = new String[js.length()];
                                datee = new String[js.length()];
...
//                                rating=new String[js1.length()];
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    cmt[i] = u.getString("complaint");
                                    datee[i] = u.getString("complaint_date");
...
//                                listView1.setAdapter(ad);
                                lv.setAdapter(new custom_cmt(getApplicationContext(), cmt,datee,reply));
//
                            }
