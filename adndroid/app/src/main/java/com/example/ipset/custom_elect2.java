...
public class custom_elect2 extends BaseAdapter {
    ...
    public custom_elect2(android.content.Context applicationContext, String[] c, String[] d,String[] e,String[] f,String[] g) {
...
//        Picasso.with(Context).load(url).networkPolicy(NetworkPolicy.NO_CACHE).memoryPolicy(MemoryPolicy.NO_CACHE).transform(new CircleTransform()).into(im);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ed.commit();
                Intent i=new Intent(Context,Cand_view_consit.class);
