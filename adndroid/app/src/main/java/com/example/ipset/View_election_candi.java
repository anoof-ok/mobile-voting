...
public class View_election_candi extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_election_candi);
...
//                                listView1.setAdapter(ad);
                                lv.setAdapter(new custom_elect2(getApplicationContext(),election_id,election_name,election_date,nomination_date,result_date));
//
                            }
