...
public class Auth_three extends AppCompatActivity implements View.OnClickListener {
    EditText ed1;
    Button b1;
    ...
    public void onClick(View view) {
        ...
        if(f==0)
        {
            ...
            String url = "http://" + hu + ":8080/very_scrt_pstt";
                            ...
                            try {
                                ...
                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                    Toast.makeText(getApplicationContext(), "success", Toast.LENGTH_LONG).show();
                                        ...
                                        Intent ij=new Intent(getApplicationContext(),auth_four.class);
                                        startActivity(ij);
                                                                }
