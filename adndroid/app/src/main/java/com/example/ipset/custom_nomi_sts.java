...
public class custom_nomi_sts extends BaseAdapter {
    ...
    public custom_nomi_sts(android.content.Context applicationContext, String[] c, String[] d,String[] e,String[] f) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.cust_nomi_sts, null);
