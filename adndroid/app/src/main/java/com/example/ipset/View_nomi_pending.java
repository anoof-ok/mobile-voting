...
public class View_nomi_pending extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_nomi_pending);
        lv=(ListView)findViewById(R.id.lv);
        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":8080/and_nomination_view_pending";
...
//                                listView1.setAdapter(ad);
                                lv.setAdapter(new custom_nomi_pending(getApplicationContext(),nomination_id,election_name,party,status));
//
                            }
